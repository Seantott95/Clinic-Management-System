...
<form method="post" action="" enctype="multipart/form-data">
	...
	<div class="form-group"><label>Portal Name:</label><input class="form-control" name="portal_name" type="text" value="<?php echo $global->portal_name;?>" /><i>portal_name</i></div>
